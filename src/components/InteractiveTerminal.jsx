...
// ── auto-play sequence ────────────────────────────────────────────────────────
const autoCommands = [
    { command: "whoami", output: ["Azaan Mehtab Khan — Full Stack Developer"] },
    { command: "skills", output: ["React · Node.js · Express · MongoDB · TypeScript"] },
...
const COMMANDS = {
    ...
    skills: () => [
        ...
        "── Tools ─────────────────────────────",
        "  Docker · Git · Figma · VS Code",
    ],
    projects: () => [
        "┌─ Projects ────────────────────────── count: 8 ─┐",
        "│  01  SkillNest       — Learning platform        │",
        "│  02  ShopHub         — E-commerce store         │",
        "│  03  Echoplex        — Social network           │",
        "│  04  Jamsession      — Music collab tool        │",
        "│  05  Ringman         — Task manager             │",
        "│  06  SidebarBased    — UI library               │",
        "│  07  ModernIndie     — Portfolio template       │",
        "│  08  Java Banking    — Console app              │",
        "└────────────────────────────────────────────────┘",
    ],
    exp: () => [
        "── Work Experience ───────────────────",
